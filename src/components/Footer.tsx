      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-slate-400 mb-4 max-w-md">
              A passionate data analyst specializing in transforming complex data into actionable insights using Power BI, SQL, Python, and Excel.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center text-slate-400">
                ...
                <span>SQL Database Analysis</span>
              </li>
              <li className="flex items-center text-slate-400">
              ...
              <li className="flex items-center text-slate-400">
                <FileSpreadsheet size={16} className="mr-2 text-blue-400" />
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-slate-400 text-sm flex items-center mt-4 md:mt-0">
            Made with <Heart size={16} className="mx-1 text-red-500" /> and data-driven insights
          </p>
        </div>
      </div>
    </footer>
